...
#endif
static const char *ng0 = "C:/Users/Callum/Desktop/FPGA/Send_Recieve/Nought.v";
...
LAB27:    memcpy(t147, t64, 8);

LAB28:    memset(t175, 0, 8);
    t176 = (t147 + 4);
...
LAB59:    memcpy(t250, t175, 8);

LAB60:    memset(t278, 0, 8);
    t279 = (t250 + 4);
...
LAB88:    t331 = (t0 + 2844);
    ...
    *((unsigned int *)t341) = (t343 | t337);
    xsi_driver_vfirst_trans_delayed(t331, 0, 0, 0LL, 0);
    t344 = (t0 + 2768);
    *((int *)t344) = 1;
...
LAB66:    memcpy(t210, t190, 8);

LAB67:    memset(t242, 0, 8);
    t243 = (t210 + 4);
...
LAB69:    if (*((unsigned int *)t201) != 0)
        goto LAB70;

LAB71:    t211 = *((unsigned int *)t190);
...
LAB90:    if (*((unsigned int *)t290) != 0)
        goto LAB91;

LAB92:    t300 = *((unsigned int *)t278);
...
LAB51:    memcpy(t242, t159, 8);

LAB52:    memset(t270, 0, 8);
    t271 = (t242 + 4);
    t272 = *((unsigned int *)t271);
    t273 = (~(t272));
    t274 = *((unsigned int *)t242);
    t275 = (t274 & t273);
    t276 = (t275 & 1U);
    if (t276 != 0)
        goto LAB78;

LAB79:    if (*((unsigned int *)t271) != 0)
        goto LAB80;
...
LAB84:    t323 = (t0 + 2880);
    ...
    *((unsigned int *)t333) = (t335 | t329);
    xsi_driver_vfirst_trans_delayed(t323, 0, 0, 0LL, 0);
    t336 = (t0 + 2776);
    *((int *)t336) = 1;
...
extern void work_m_00000000002654754806_0324841756_init()
{
	static char *pe[] = {(void *)Cont_33_0,(void *)Cont_33_1,(void *)Cont_33_2,(void *)Cont_33_3,(void *)Cont_33_4};
	xsi_register_didat("work_m_00000000002654754806_0324841756", "isim/ChannelTest_Output_isim_beh.exe.sim/work/m_00000000002654754806_0324841756.didat");
